...
import com.tweak.house.categories.Lockscreen;
import com.tweak.house.categories.NotificationsPanel;
import com.tweak.house.categories.StatusBar;
import com.tweak.house.categories.System;
import com.tweak.house.categories.Themes;

import com.tweak.house.navigation.BubbleNavigationConstraintView;
import com.tweak.house.navigation.BubbleNavigationChangeListener;

public class TweakHouse extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.blazehouse_title);
    ...
    public int getMetricsCategory() {
        return MetricsProto.MetricsEvent.TWEAK_HOUSE;
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_HELP, 0, R.string.blazehouse_dialog_title)
                .setIcon(R.drawable.ic_blazehouse_info)
